var Intl = {
	...
	messages: {
		...
		vote: {
			...
			PRINT_VOTER_CARD: 'Imprimer ma carte d\'électeur',
			DOWNLOAD_VOTER_CARD: 'Télécharger ma carte d\'électeur',
			BEFORE_UNLOAD_MESSAGE: 'Si vous quittez ou actualiez cette page, vous ne pourrez jamais récupérer votre carte d\'électeur.',
			EXIT: 'Terminer',
			EXIT_WITHOUT_VOTER_CARD: 'Terminer sans récupérer ma carte d\'électeur',
			...
			STEP_1_TITLE: 'Votre carte d\'électeur',
			STEP_2_TITLE: 'Confirmation de votre vote',
			STEP_3_TITLE: 'A voté !',
			STEP_1_NAME: 'Carte d\'électeur',
			STEP_2_NAME: 'Confirmation',
			STEP_3_NAME: 'A voté !',
		...
		proofOfVoteReader : {
			PROVIDE_VOTER_CARD: 'Pour continuer, merci de fournir votre carte d\'électeur',
			SCAN_PRINTED_FILE: 'Utiliser ma webcam pour scanner ma carte d\'électeur imprimée',
			SEND_DOWNLOADED_FILE: 'Envoyer le fichier de ma carte d\'électeur téléchargée',
			BACK: 'Retour',
			CANCEL: 'Annuler'
		},
