var Intl = {
	...
	messages: {
		...
		vote: {
			...
			CONFIRM_VOTE_MESSAGE: 'Vous êtes sur le point de voter { value } au sujet du texte { vote }. Confirmez-vous votre choix ?',
			I_CONFIRM_MY_VOTE: 'je confirme : ',
			CANCEL_MY_VOTE: 'Annuler mon vote',
			IGNORE: 'Ignorer',
			NOT_RECOMMENDED: 'non recommandé',
			YOUR_VOTE_IS_BEING_RECORDED: 'Votre vote { value } au sujet du texte { vote } est en cours d\'enregistrement...',
			YOUR_VOTE_IS_COMPLETE: 'Votre vote { value } au sujet du texte { vote } a bien été envoyé !',
