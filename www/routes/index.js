...
exports = module.exports = function(app) {
	...
	app.get('/api/vote/result/per-gender/:textId', keystone.middleware.api, routes.api.vote.resultPerGender);
	app.get('/api/vote/result/per-age/:textId', keystone.middleware.api, routes.api.vote.resultPerAge);
	app.get('/api/vote/result/per-date/:textId', keystone.middleware.api, routes.api.vote.resultPerDate);
	...
	app.get('/api/argument/list/:textId', keystone.middleware.api, routes.api.argument.list);
	app.post('/api/argument/add', keystone.middleware.api, isAuthenticated, routes.api.argument.add);
	app.get('/api/argument/like/add/:id/:value', keystone.middleware.api, isAuthenticated, routes.api.argument.addLike);
	app.get('/api/argument/like/remove/:id', keystone.middleware.api, isAuthenticated, routes.api.argument.removeLike);
